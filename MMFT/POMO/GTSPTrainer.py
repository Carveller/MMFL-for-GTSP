...
class TSPTrainer:
    ...
    def _train_one_batch(self, batch_size):
        ...
        prob_list = torch.zeros(size=(batch_size, self.env.pomo_size, 0), device=torch.device('cuda'))
        ...
        grad_norms = self.clip_grad_norms(self.optimizer.param_groups, self.model_params['max_grad_norm'])
